...
library Address {
     ...
     *  certain opcodes, possibly making contracts go over the 2300 gas limit
 ...
 */
contract BEP721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    */
    ...
    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        require(BEP721.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own"); // internal owner
